...
const s = {
  ...
  btnPrimary: { width: '100%', padding: '1rem', fontSize: '1rem', fontWeight: 700, border: 'none', borderRadius: '10px', cursor: 'pointer', background: '#2D3A35', color: '#C5A059' },
  btnSmall: { padding: '0.75rem 1.25rem', fontSize: '0.875rem', fontWeight: 700, border: 'none', borderRadius: '10px', cursor: 'pointer', background: '#2D3A35', color: '#C5A059' },
