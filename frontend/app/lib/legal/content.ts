...
const privacyContent: Record<SupportedLegalLanguage, LegalPageContent> = {
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['PayPal', '글로벌', '결제자 정보, 주문, 승인, 결제 상태', '결제 처리'], ['PortOne(코리아포트원)', '대한민국', '결제 요청·승인·거래 상태', '국내 결제대행(카드·간편결제) 처리'],
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            ['PayPal', 'Global', 'Payer, order, authorization, and payment status data', 'Payment processing'], ['PortOne (Korea PortOne)', 'South Korea', 'Payment request, approval, and transaction status', 'Domestic payment gateway processing (cards, easy pay)'],
  ...
  zh: {
    ...
    sections: [
      ...
      { title: '4. 跨境处理与服务商', body: ['出生日期、出生时间、性别、出生地和生成报告在与孩子或家庭相关时均按个人信息处理。', '在欧洲经济区（EEA）、英国或韩国以外处理个人信息时，将依据欧盟委员会批准的标准合同条款（SCC）或同等法律保障措施进行传输。'], table: { headers: ['服务商', '地区', '信息', '目的'], rows: [['Supabase', '美国/全球', '账户、报告、支付相关数据库信息', '数据库和认证'], ['AWS', '韩国/全球', 'API请求和服务器处理数据', '后端运行和日志'], ['Cloudflare', '全球', '网页请求、缓存、安全日志', '网站托管和安全'], ['OpenAI 或 Google Gemini', '美国/全球', '分析所需的最少四柱数据', 'AI报告生成'], ['PayPal', '全球', '付款人、订单、授权、支付状态', '支付处理'], ['PortOne（韩国）', '韩国', '支付请求、授权、交易状态', '韩国境内支付代理处理'], ['Resend', '美国/全球', '邮箱、报告邮件/PDF', '邮件发送'], ['Google Analytics', '全球', 'Cookie、设备和使用事件', '基于同意的分析']] } },
